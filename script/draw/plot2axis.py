...
class ExprPloter(object):
    def __init__(self, xLabel, yLabels):
        ...
        self.needFiles = set(["k_50_size_80_offset_0",
                              ...
                              "width_12_k_50_size_80_offset_0","_line"])
...
def plotScaleForWeibo():
    inputPath = "/home/xiafan/Dropbox/数据/weibo_result/weibo_50_hasresult"
    outputDir = "/home/xiafan/Dropbox/数据/weibo_result/weibo_50_hasresult_scala_fig"
    inputPath = "/Users/kc/Dropbox/数据/weibo_result/weibo_50_hasresult"
    outputDir = "/Users/kc/Dropbox/数据/weibo_result/weibo_50_hasresult_scala_fig"
    ...
    config = {"scalex":False, "scaley":False, "ylim":yrange, "leg":('upper left', 2), "legsize":17}
    ploter.plotFigures(os.path.join(outputDir, "size"), config)

def plotScaleForTwitter():
    inputPath = "/home/xiafan/Dropbox/数据/twitter_result/twitter_50_hasresult"
    outputDir = "/home/xiafan/Dropbox/数据/twitter_result/twitter_50_hasresult_scale_fig"
    
    inputPath = "/Users/kc/Dropbox/数据/twitter_result/twitter_50_hasresult"
    outputDir = "/Users/kc/Dropbox/数据/twitter_result/twitter_50_hasresult_scale_fig"
...
def plotLimitForWeibo():
    ...
    outputDir="/home/xiafan/expr/limit_50/twitter_fig"
    inputPath="/home/xiafan/expr/tao/weibo"
    outputDir="/home/xiafan/expr/tao/weibo_fig"
    inputPath="/home/xiafan/expr/limit_50/weibo"
    outputDir="/home/xiafan/expr/limit_50/weibo_fig"
    #inputPath="/home/xiafan/expr/limit_50/weibo"
    #outputDir="/home/xiafan/expr/limit_50/weibo_fig"
    ...
    ploter.loadFiles(inputPath)
    config = {"scalex":False, "scaley":False, "ylim":[1, 300], "leg":('upper left', 2), "legsize":18}
...
def plotAllForWeibo():
    ...
    ploter.loadFiles(inputPath)
    config = {"scalex":True, "scaley":False, "ylim":[10, 600], "leg":('upper left', 2), "legsize":18}
    ...
    # query width
    config = {"scalex":True, "scaley":False, "ylim":[10, 1400], "leg":('upper left', 1), "legsize":18}
...
def plotAllForTwitter():
    inputPath = "/home/xiafan/Dropbox/数据/twitter_result/twitter_50_hasresult"
    outputDir = "/home/xiafan/Dropbox/数据/twitter_result/twitter_50_hasresult_fig"
    # offset
    ploter = ExprPloter("Offset(hour)", ["Latency(ms)"])
    ploter.addLines(LineDef({"width":"width", "k":"k", "size":"size"}, {"app":"app", "type":"type"}, "offset", "TOTAL_TIME", 0))
    ploter.loadFiles(inputPath)
    config = {"scalex":True, "scaley":False, "ylim":[1, 140], "leg":('upper left', 2), "legsize":18}
    ploter.plotFigures(os.path.join(outputDir, "offset"), config)
    ...
    ploter.addLines(LineDef({"width":"width", "offset":"offset", "size":"size"}, {"app":"app", "type":"type"}, "k", "TOTAL_TIME", 0))
    ploter.loadFiles(inputPath)
    config = {"figsize":(15, 10), "scalex":False, "scaley":False, "ylim":[10, 110], "leg":('upper left', 3), "legsize":25}
    ploter.plotFigures(os.path.join(outputDir, "k"), config)

    # query width
    config = {"scalex":True, "scaley":False, "ylim":[1, 800], "leg":('upper left', 2), "legsize":18}
    ploter = ExprPloter("Query interval length(hour)", ["Latency(ms)"])
    ploter.addLines(LineDef({"k":"k", "offset":"offset", "size":"size"}, {"app":"app", "type":"type"}, "width", "TOTAL_TIME", 0))
    ploter.loadFiles(inputPath)
    ploter.plotFigures(os.path.join(outputDir, "width"), config)
...
def plotThroughputForWeibo():
    # 需要人为设置一下ncol=2
    trange = [100, 250000000]
    inputPath = "/Users/kc/Dropbox/数据/throughput/weibo_throughput"
    outputDir = "/Users/kc/Dropbox/数据/throughput/weibo_throughput_fig"
    ...
    ploter.loadFiles(inputPath)
    config = {"scalex":False, "scaley":True, "ylim":trange, "leg":('upper right', 1), "xSize":18}
    ploter.plotFigures(os.path.join(outputDir, "throughput"), config)

def plotThroughputForTwitter():
    # 需要人为设置一下ncol=2
    inputPath = "/Users/kc/Dropbox/数据/throughput/twitter_throughput"
    outputDir = "/Users/kc/Dropbox/数据/throughput/twitter_throughput_fig"
    trange = [100, 350000000]

    ploter = ExprPloter("Time(mins)", ["#Query"])
    ploter.addLines(LineDef({"":"line"}, {"app":"app", "query":"query"}, "time", "perf.query.count", 0))
    ploter.addLines(LineDef({"":"line"}, {"app":"app", "insert":"insert"}, "time", "perf.insert.count", 0))
    ploter.loadFiles(inputPath)
    config = {"scalex":False, "scaley":True, "ylim":trange, "leg":('upper right', 1)}
    ploter.plotFigures(os.path.join(outputDir, "throughput"), config)

def plotUpdateScaleForWeibo():
    inputPath = "/Users/kc/Dropbox/数据/weibo_result/update_scale"
    outputDir = "/Users/kc/Dropbox/数据/weibo_result/update_scale_fig"
    ...
    ploter.loadFiles(inputPath)
    config = {"scalex":False, "scaley":False,"ylim":[20,240],"ylim1":[0.05, 0.35], "leg":('upper center', 1)}
    ploter.plotFigures(os.path.join(outputDir, "scale"), config)

def plotUpdateScaleForTwitter():
    inputPath = "/Users/kc/Dropbox/数据/twitter_result/update"
    outputDir = "/Users/kc/Dropbox/数据/twitter_result/update_fig"
    ...
    ploter.addLines(LineDef({"":"line"}, {"app":"app", "insert total":"Compact"}, "size", "perf.insert_total.totalTime", 0))
    ploter.loadFiles(inputPath)
    config = {"scalex":False, "scaley":False,"ylim":[20,200],"ylim1":[0.05, 0.3], "leg":('upper left', 1)}
    ploter.plotFigures(os.path.join(outputDir, "scale"), config)

def plotKeywordsForTwitter():
    inputPath = "/home/xiafan/Dropbox/数据/twitter_result/keywordnum"
    outputDir = "/home/xiafan/Dropbox/数据/twitter_result/keywordnum_fig"
    yrange = [1, 200]

    ploter = ExprPloter("Number of Keywords", ["Latency(ms)"])
    ploter.addLines(LineDef({"offset":"offset", "width":"width", "k":"k", "size":"size"}, {"app":"app", "type":"type"}, "words", "TOTAL_TIME", 0))
    ploter.loadFiles(inputPath)
    config = {"scalex":False, "scaley":False, "ylim":yrange, "leg":('upper left', 2), "legsize":18,"suffix":"_words"}
    ploter.plotFigures(os.path.join(outputDir, "words"), config)

def plotKeywordsForWeibo():
    inputPath = "/home/xiafan/Dropbox/数据/weibo_result/keywordnum"
    outputDir = "/home/xiafan/Dropbox/数据/weibo_result/keywordnum_fig"
    inputPath = "/Users/kc/Dropbox/数据/weibo_result/keywordnum"
    outputDir = "/Users/kc/Dropbox/数据/weibo_result/keywordnum_fig"
