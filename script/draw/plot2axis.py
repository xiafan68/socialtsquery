...
class ExprPloter(object):
    def __init__(self, xLabel, yLabels):
        ...
        self.needFiles = set(["k_50_size_80_offset_0",
                              ...
                              "width_12_k_50_size_80_offset_0"])
...
def plotAllForWeibo():   
    inputPath = "/home/xiafan/Dropbox/数据/weibo_result/weibo_50_hasresult"
    outputDir = "/home/xiafan/Dropbox/数据/weibo_result/weibo_50_hasresult_fact_fig"
    # offset
    ...
    ploter.loadFiles(inputPath)
    config = {"figsize":(15, 10), "scalex":False, "scaley":False, "ylim":[10, 470], "leg":('upper left', 3), "legsize":25}
    ploter.plotFigures(os.path.join(outputDir, "k"), config)

    # query width
    config = {"scalex":True, "scaley":True, "ylim":[10, 10000], "leg":('upper left', 2), "legsize":18}
