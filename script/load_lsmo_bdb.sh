...
do
    to=`expr $i + 4`
    echo $to
    java -Xms5000M -Xmx5000M -cp target/socialtsquery-1.0-jar-with-dependencies.jar util.IndexLoader -l conf/log4j-server2.properties -c conf/weibo/lsmo_bdb_scale/index_lsmo_bdb_weibo_part$i.conf -d ${dataDir}/part$i -e ./update_lsmo_bdb_part$i.txt
